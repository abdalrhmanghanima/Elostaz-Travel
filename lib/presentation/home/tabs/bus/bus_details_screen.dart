...
import 'package:elostaz_travel/presentation/home/tabs/bus/widgets/bus_info_item.dart';
...
class BusDetailsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final localImagesAsync = ref.watch(busLocalImagesProvider(currentBus.id!));
    ...
    final bool isLicenseValid = currentBus.licenseExpiryDate.isAfter(
      DateTime.now(),
    );
            ...
            child: InkWell(
              ...
              onTap: () async {
                ...
                final action = await showModalBottomSheet<BusActionType>(
                  ...
                  builder: (_) =>
                      BusActionsBottomSheet(drivers: drivers, bus: currentBus),
                );
                ...
                if (action == BusActionType.addTrip) {
                  await showModalBottomSheet(
                    ...
                    builder: (_) =>
                        AddTripBottomSheet(drivers: drivers, bus: currentBus),
                  );
                          ...
                          ({
                            ...
                            try {
                              final updatedBus = BusEntity(
                                ...
                                modelYear:
                                    manufacturingYear ?? currentBus.modelYear,
                              ...
                              await LicenseNotificationService.instance
                                  .rescheduleBusLicenseNotifications(
                                    updatedBus,
                                  );
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Align(
                                ...
                                child: CustomText(
                                  title:
                                      (currentBus.manufacturingYear != null &&
